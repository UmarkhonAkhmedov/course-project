...
function UserManagement({ admin }) {
  ...
  const handleDeleteProperty = async () => {
    for (let i = 0; i < select.length; i++) {
      try {
        const url = `https://course-project-rgk2.vercel.app/users/delete/${select[i]}`;
  ...
  const handleUpdateStatusBlock = async () => {
    for (let i = 0; i < select.length; i++) {
      try {
        const url = `https://course-project-rgk2.vercel.app/users/status/${select[i]}`;
  ...
  const handleUpdateNotAdmin = async () => {
    for (let i = 0; i < select.length; i++) {
      try {
        const url = `https://course-project-rgk2.vercel.app/users/admin/${select[i]}`;
